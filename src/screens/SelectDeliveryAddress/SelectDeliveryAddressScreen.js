...
import SelectAddressSingleView from '../Custom/SelectAddressSingleView';
import ImageCircleButton from '../Custom/ImageCircleButton';
    ...
    <SafeAreaView style={{flex: 1}}>
      <View
        ...
        <ImageCircleButton
          ...
          margin={10}
        />
        <Text style={[Styles.customFontMedium, {color: theme.colors.text}]}>
          Add a new address
        </Text>
      </View>
      <FlatList
